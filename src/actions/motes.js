import { MOTES_REMOVE, MOTES_SET, MOTES_ADD, MOTES_FILL_POOLS, MOTES_DRIP, MOTES_COMMIT, MOTES_RELEASE } from "../types/motes";
...
export const addMotes    = (personal = 0, periferal = 0) => (
  {type: MOTES_ADD, personal, periferal}
)
...
export const removeMotes = (personal = 0, periferal = 0) => (
  {type: MOTES_REMOVE, personal, periferal}
)
 ...
 */
export const dripMotes = (number = 5) => (
  {type: MOTES_DRIP, number}
)
...
export const fillMotePools = (personal = true, periferal = true) => (
  {type: MOTES_FILL_POOLS, personal, periferal}
)
...
export const setMotes = (personal, periferal) => (
  {type: MOTES_SET, personal, periferal}
)
...
export const commitMotes = (effect, personal = 0, periferal = 0) => (
  {type: MOTES_COMMIT, effect, personal, periferal}
)
 ...
 */
export const releaseMotes = (effectID) => (
  {type: MOTES_RELEASE, effectID}
)
