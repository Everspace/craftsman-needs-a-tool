...
import { ADD_SUCCESSES, SET_SUCCESSES, USE_SUCCESSES, REMOVE_SUCCESSES } from "types/successes";
...
export const setSuccesses = (current, used = 0) => ({type: SET_SUCCESSES, current, used})
